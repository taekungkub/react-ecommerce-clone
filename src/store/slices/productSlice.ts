...
import { FetchStatusTy, ProductTy } from "../../types/Common.type";
...
export const getProductStatus = (state: RootState) => state.product.productsStatus;
export const getProduDataStatus = (state: RootState) => state.product.productDataStatus;

// export const selectProductById = (state: RootState , id:number) => state.productReducer.products.find((v)=> v.id === id)

export const getSmarthphones = (state: RootState) => state.product.products.filter((v) => v.category === "smartphones");
export const getLaptops = (state: RootState) => state.product.products.filter((v) => v.category === "laptops");
export const getSkincares = (state: RootState) => state.product.products.filter((v) => v.category === "skincare");
